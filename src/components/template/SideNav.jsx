  ...
  return (
    <div className=" min-w-[15vw] z-30   h-screen  fixed  bg-[#1f1e24]   border-r-2 border-zinc-400 px-10 py-1  whitespace-nowrap">
      ...
      <nav className="flex flex-col text-zinc-400 text-xl gap-y-2">
        ...
        <Link className="hover:bg-[#cd5856] hover:scale-110 hover:text-white rounded-lg  duration-300 p-2">
          <h1>
            {" "}
            Popular<i className="ri-bar-chart-grouped-line ml-2"></i>
          </h1>
        </Link>
        <Link className="hover:bg-[#8b7532] hover:scale-110 hover:text-white rounded-lg  duration-300 p-2">
          <h1>
            Movies
            <i className="ri-movie-2-fill ml-3"></i>
          </h1>
        </Link>
        <Link className="hover:bg-[#6556cd] hover:scale-110 hover:text-white rounded-lg duration-300 p-2 flex items-center">
          Tv Shows <i className="ri-tv-line ml-2"></i>
        </Link>

        <Link className="hover:bg-[#631570] hover:scale-110 hover:text-white rounded-lg  duration-300 p-2">
          <h1>
            People
      ...
      <nav className="flex flex-col text-zinc-400 text-xl gap-y-2">
        ...
        <Link className="hover:bg-[#0c301c] hover:scale-110 hover:text-white rounded-lg  duration-300 p-2">
