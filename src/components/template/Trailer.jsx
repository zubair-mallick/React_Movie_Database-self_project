...
function Trailer(props) {
    ...
    const id = useSelector(state => state.movie.info.details.id); 
    let linking
    ...
    return (
        <div className='h-screen w-[100%] absolute bg-[#0000005a] z-40 top-0 left-0 flex items-center justify-center'>
            ...
            <div className=' relative md:h-[60vh] lg:h-[80vh]  xl:h-screen h-[40vh] w-[100vw] flex items-center justify-center'>
            <Link to={linking}
