  ...
  return (
    <div className="flex flex-wrap gap-[1.37%] w-full">
      {data.map((person, index) => (
        <Link to={`/person/${person.id}`} className="w-[47%] h-[full] md:w-[30%] lg:w-[18.9%] mb-5 relative group overflow-hidden hover:scale-105 shadow-lg transition-transform duration-300 ease-in-out" key={index}>
          <img 
